...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Tag&&(identical(other.name, name) || other.name == name)&&(identical(other.hexColor, hexColor) || other.hexColor == hexColor));
}
...
@override
String toString() {
  return 'Tag(name: $name, hexColor: $hexColor)';
}
...
class _Tag implements Tag {
  const _Tag({required this.name, required this.hexColor});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Tag&&(identical(other.name, name) || other.name == name)&&(identical(other.hexColor, hexColor) || other.hexColor == hexColor));
}
