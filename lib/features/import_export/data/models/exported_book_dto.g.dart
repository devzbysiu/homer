...
part of 'exported_book_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ExportedBookDTO _$ExportedBookDTOFromJson(Map<String, dynamic> json) =>
    ExportedBookDTO(
      ...
      tags: (json['tags'] as List<dynamic>)
          .map((e) => ExportedTagDTO.fromJson(e as Map<String, dynamic>))
          .toList(),
      startDate: _toDate((json['startDate'] as num).toInt()),
      endDate: _toDate((json['endDate'] as num).toInt()),
    );

Map<String, dynamic> _$ExportedBookDTOToJson(ExportedBookDTO instance) =>
    <String, dynamic>{
